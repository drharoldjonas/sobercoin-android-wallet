...
import com.google.sobercoin.core.VersionMessage;
...
public final class AboutActivity extends SherlockPreferenceActivity
{
	...
	private static final String KEY_ABOUT_CREDITS_SOBERCOINJ = "about_credits_sobercoinj";
	...
	protected void onCreate(final Bundle savedInstanceState)
	{
		...
		findPreference(KEY_ABOUT_CREDITS_SOBERCOINJ).setTitle(getString(R.string.about_credits_sobercoinj_title, VersionMessage.SOBERCOINJ_VERSION));
		findPreference(KEY_ABOUT_CREDITS_SOBERCOINJ).setSummary(Constants.CREDITS_SOBERCOINJ_URL);
	...
	public boolean onPreferenceTreeClick(final PreferenceScreen preferenceScreen, final Preference preference)
	{
		...
		else if (KEY_ABOUT_CREDITS_SOBERCOINJ.equals(key))
		{
			startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(Constants.CREDITS_SOBERCOINJ_URL)));
			finish();
		}
