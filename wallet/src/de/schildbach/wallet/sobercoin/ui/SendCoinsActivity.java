...
public final class SendCoinsActivity extends AbstractWalletActivity
{
	...
	private void handleIntent(final Intent intent)
	{
		...
		if ((Intent.ACTION_VIEW.equals(action) || NfcAdapter.ACTION_NDEF_DISCOVERED.equals(action)) && intentUri != null && "sobercoin".equals(scheme))
		{
			try
			{
				final SobercoinURI sobercoinUri = new SobercoinURI(null, intentUri.toString());
				address = sobercoinUri.getAddress().toString();
				addressLabel = sobercoinUri.getLabel();
				amount = sobercoinUri.getAmount();
			}
