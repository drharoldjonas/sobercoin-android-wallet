...
import com.google.sobercoin.core.ProtocolException;
import com.google.sobercoin.core.Sha256Hash;
import com.google.sobercoin.core.Transaction;
import com.google.sobercoin.core.VerificationException;
...
public final class TransactionActivity extends AbstractWalletActivity
{
	...
	private void updateView()
	{
		...
		if (nfcManager != null)
			NfcTools.publishMimeObject(nfcManager, this, Constants.MIMETYPE_TRANSACTION, tx.unsafeSobercoinSerialize(), false);
	}
