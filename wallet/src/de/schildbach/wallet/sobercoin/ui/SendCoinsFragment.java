...
import com.google.sobercoin.core.*;
import com.google.sobercoin.core.TransactionConfidence.ConfidenceType;
import com.google.sobercoin.core.Wallet.BalanceType;
import com.google.sobercoin.core.Wallet.SendRequest;
import com.google.sobercoin.uri.SobercoinURI;
import com.google.sobercoin.uri.SobercoinURIParseException;

import com.google.zxing.integration.android.IntentIntegrator;
import com.google.zxing.integration.android.IntentIntegratorSupportV4;
import com.google.zxing.integration.android.IntentResult;
import de.schildbach.wallet.sobercoin.AddressBookProvider;
import de.schildbach.wallet.sobercoin.Constants;
import de.schildbach.wallet.sobercoin.WalletApplication;
import de.schildbach.wallet.sobercoin.integration.android.SobercoinIntegration;
import de.schildbach.wallet.sobercoin.service.BlockchainService;
import de.schildbach.wallet.sobercoin.service.BlockchainServiceImpl;
...
public final class SendCoinsFragment extends SherlockFragment implements AmountCalculatorFragment.Listener
{
	...
	private final CurrencyAmountView.Listener amountsListener = new CurrencyAmountView.Listener()
	{
		...
		{
			dismissPopup();
            Log.d("Sobercoin", "Amount: " + amountView.getAmount() + ", Fee: " + feeView.getAmount());
		...
		viewGo.setOnClickListener(new OnClickListener()
		{
			...
			private void feeDialog()
			{
				...
				dialog.setMessage(getString(R.string.send_coins_dialog_fee_message,
						Constants.CURRENCY_CODE_SOBERCOIN + " " + WalletUtils.formatValue(Constants.DEFAULT_TX_FEE, Constants.XSC_PRECISION)));
				if (allowLowFee)
				{
	...
	private void popupAvailable(final View anchor, final BigInteger available, final BigInteger pending)
	{
		...
		viewAvailable.setPrefix(Constants.CURRENCY_CODE_SOBERCOIN);
		...
		viewPending.setText(getString(R.string.send_coins_fragment_pending, WalletUtils.formatValue(pending, Constants.XSC_PRECISION)));
	...
	private void handleGo()
	{
		...
		backgroundHandler.post(new Runnable()
		{
			public void run()
			{
                ...
                Log.d("Sobercoin", "Transaction size is " + txSize);
                /* From official Sobercoin wallet.cpp
                ...
                */
                ...
                {
                    Log.i("SobercoinSendCoins", "Recalculated fee: " +
                                ...
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        try {
                                            ...
                                            Log.i("SobercoinSendCoins", "VerificationException: " + e);
                                            return;
                                        }
                                        // Fees are agreeable
    ...
    class TransactionRunnable implements Runnable {
        ...
        public void run()
        {
            ...
            SobercoinIntegration.transactionHashToResult(result, sentTransaction.getHashAsString());
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (scanResult != null) {
            SobercoinURI uri = WalletUtils.parseAddressString(scanResult.getContents());
            if(uri != null)
	...
	private void updateView()
	{
		...
		if (sentTransaction != null)
		{
			...
			sentTransactionListAdapter.setPrecision(Integer.parseInt(prefs.getString(Constants.PREFS_KEY_XSC_PRECISION,
					Integer.toString(Constants.XSC_PRECISION))));
