...
import de.schildbach.wallet.sobercoin.util.EncryptionUtils;
import de.schildbach.wallet.sobercoin.util.IOUtils;
import de.schildbach.wallet.sobercoin.util.Iso8601Format;
                ...
                if(args.getInt("next") == DIALOG_NEXT_GET_NEW_APP) {
                    ...
                    builder
                        ...
                        .setNeutralButton(R.string.button_import_into_new_app, new OnClickListener() {
                            public void onClick(DialogInterface dialogInterface, int i) {
                                // Throw import intent to sobercoin app
                                Intent sendIntent = new Intent();
                                sendIntent.setAction(Intent.ACTION_VIEW);
                                Uri uri = Uri.fromFile(file);
                                Log.i(TAG, "URI to file: " + uri);
                                sendIntent.setDataAndType(uri, "x-sobercoin/private-keys");
