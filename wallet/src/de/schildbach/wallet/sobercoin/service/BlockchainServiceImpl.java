...
package de.schildbach.wallet.sobercoin.service;
...
import com.google.sobercoin.discovery.*;
import com.google.sobercoin.store.BlockStore;
import com.google.sobercoin.store.BlockStoreException;

import com.google.sobercoin.store.SPVBlockStore;
import de.schildbach.wallet.sobercoin.Constants;
import de.schildbach.wallet.sobercoin.WalletApplication;
import de.schildbach.wallet.sobercoin.WalletBalanceWidgetProvider;
import de.schildbach.wallet.sobercoin.ui.WalletActivity;
import de.schildbach.wallet.sobercoin.util.ThrottelingWalletChangeListener;
...
public class BlockchainServiceImpl extends android.app.Service implements BlockchainService
{
	...
	private static final String TAG = "Sobercoin"+BlockchainServiceImpl.class.getSimpleName();
	...
	private void notifyCoinsReceived(final Address from, final BigInteger amount)
	{
		...
		final int precision = Integer.parseInt(prefs.getString(Constants.PREFS_KEY_XSC_PRECISION, Integer.toString(Constants.XSC_PRECISION)));
		...
		private void check()
		{
			...
			if (hasEverything && peerGroup == null)
			{
                ...
                try {
                    ...
                    Log.e("Sobercoin", "There's no method: " + e.getLocalizedMessage());
                    Log.e("Sobercoin", "Sobercoinj issue.  We're going to ignore this for now and just try and return nicely.");
                    return;
                }
		...
		try
		{
            ...
            if (!blockChainFileExists) { // Starting from scratch
                try {
                    ...
                    Log.d("Sobercoin", "Couldn't find checkpoints file; starting from genesis");
                }
            }
	...
	public void notifyWidgets()
	{
        ...
        try {
            ...
            Log.e("Sobercoin", "App server appears dead - Runtime Exception when running getAppWidgetIds.  Returning..");
            return;
        }
